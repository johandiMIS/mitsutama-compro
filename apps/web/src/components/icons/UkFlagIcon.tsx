...
// Adapted from circle-flags (https://github.com/HatScripts/circle-flags), MIT licensed.
// Unlike other icons in this folder, a flag has fixed real-world colors — it does not
// accept a `color` prop the way stroke-based icons do.
export function UkFlagIcon({ size = 16 }: { size?: number }) {
  const maskId = useId();
